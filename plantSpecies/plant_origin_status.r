# Create a master list of native/alien status based on USDA Plants Database.
# Additional species may get added to the list in ad hoc fashion.

library(tidyverse)

## Expanded USDA plants database (provided March 2024)
...
origin = read_csv('plantSpecies/PLANTS_Data_Expanded_2024.csv', locale=locale(encoding="latin1")) %>%
...
write.csv(expandedOrigin, 'plantSpecies/plant_origin_status.csv', row.names = F)
